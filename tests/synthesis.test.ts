...
describe("deterministic synthesis", () => {
  ...
  test("empty wiki → spine empty, digest points to /wiki-save", () => {
    ...
    // language-neutral: both en/ko empty messages point to /wiki-save
    expect(buildDigest(empty)).toContain("/wiki-save");
